...
import com.SmProjects.dreamshops.model.CartItem;
import com.SmProjects.dreamshops.model.Product;
import com.SmProjects.dreamshops.repository.CartItemRepository;
import com.SmProjects.dreamshops.repository.CartRepository;
...
public class CartItemService implements ICartItemService {
    ...
    public CartItem getCartItem(Long cartId, Long productId) {
        ...
        return cart.getItems().stream()
                .filter(item-> item.getProduct().getId().equals(productId))
                .findFirst().orElseThrow(()->new ResourceNotFoundException("Item Not Fount!"));
    }
}
